...
const portableTextComponents = {
  block: {
    ...
    h3: ({ children }) => (
      <h3 className="text-2xl md:text-3xl font-semibold my-5 text-brand-dark font-heading leading-tight">
        {children}
      </h3>
    ),
    h4: ({ children }) => (
      <h4 className="text-xl md:text-2xl font-semibold my-4 text-brand-dark font-heading">
        {children}
      </h4>
    ),
    normal: ({ children }) => (
  ...
  list: {
    ...
    number: ({ children }) => (
      <ol className="list-decimal list-inside my-6 ml-4 space-y-3 text-lg">{children}</ol>
    ),
  },
  listItem: {
    bullet: ({ children }) => (
    ...
    number: ({ children }) => (
      <li className="text-lg leading-relaxed text-brand-dark/90 mb-2">{children}</li>
    ),
  },
  marks: {
    strong: ({ children }) => (
      <strong className="font-bold text-brand-dark bg-citius-orange/10 px-1 py-0.5 rounded">
        {children}
      </strong>
    ),
