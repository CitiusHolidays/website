...
import { PlaneTakeoffIcon, Sparkle, Telescope } from "lucide-react";
    ...
    <>
      ...
      <AnimatedSection>
        <section className="px-4 py-16 text-center bg-white">
          <h2 className="mb-6 text-3xl font-semibold text-brand-dark">
            Our Team
          </h2>
      ...
      <AnimatedSection>
        <section className="overflow-hidden relative px-4 py-24 bg-gradient-to-b from-white to-white via-brand-light/40">
