    ...
    <>
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-6 right-6 z-50 bg-green-600 hover:bg-green-600/90 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
          onClick={toggleChat}
        >
          <MessageCircle
            size={24}
