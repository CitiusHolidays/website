...
function DashboardView({ summary }) {
  ...
  const metrics = [
    ["Active Queries", summary.metrics.activeQueries, ClipboardList],
    ["Proposals Sent", summary.metrics.proposalsSent, FileText],
    ["Confirmed Jobs", summary.metrics.confirmedJobs, CheckCircle2],
    ["Open Job Cards", summary.metrics.jobCardsOpen, BriefcaseIcon],
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-5 xl:grid-cols-[1.35fr_0.9fr]">
        ...
        <Panel title="Urgent actions">
          {(summary.urgentActions || []).length === 0 ? <EmptyState label="No urgent actions." /> : (
            <div className="space-y-3">
              {summary.urgentActions.map((item, index) => (
                <motion.div
                  key={item.id}
      ...
      <Panel title="Overall progress">
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          <Progress label="Tickets issued / total pax" value={summary.progress.tickets.percent} />
