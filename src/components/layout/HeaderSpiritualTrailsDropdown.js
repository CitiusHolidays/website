  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className={`group relative flex min-h-11 shrink-0 items-center gap-1 whitespace-nowrap rounded-full px-4 py-2 font-medium text-sm transition-colors duration-200 ${triggerTone}`}
