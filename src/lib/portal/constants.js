...
export const PORTAL_NAV_GROUPS = [
  {
    label: "Overview",
    items: [{ href: "/portal", label: "Dashboard", page: "dashboard", permission: P.VIEW_DASHBOARD }],
  },
  {
    label: "Enquiries",
    items: [
  ...
  },
  {
    label: "System",
    items: [
      { href: "/portal/activity", label: "Activity Log", page: "activity", permission: P.VIEW_ACTIVITY },
