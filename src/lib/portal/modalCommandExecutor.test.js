...
import { createProductionModalCommandAdapter } from "./modalCommandAdapter";
import { executeModalCommand as executeWithAdapter } from "./modalCommandExecutor";
...
function makeDeps(overrides = {}) {
  ...
  return {
    calls,
    deps: createProductionModalCommandAdapter({
...
function executeModalCommand({ deps, ...request }) {
