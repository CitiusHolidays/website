...
export type RuntimePrimitive = bigint | boolean | null | number | string | undefined;

export type RuntimeValue = Date | Error | RuntimeObject | RuntimePrimitive | RuntimeValue[];
...
export function hasOwnKey<ObjectType extends object>(
  ...
  // biome-ignore lint: Convex's configured TypeScript lib predates Object.hasOwn.
