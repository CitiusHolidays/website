...
export const __convexExportSurface = [
  ...
  crm_lib.DIRECTOR_PERMISSIONS,
  crm_lib.TEAM_PICKER_PERMISSIONS,
  crm_lib.CONTRACTING_TEAM_ROLES,
  crm_lib.TICKETING_TEAM_ROLES,
  crm_lib.SALES_REP_ROLES,
  ...
  crm_proposals.listPage,
  crm_proposals.getListRow,
