...
| Operational synthetic-test signing | `OPERATIONAL_CONTROL_TEST_SIGNING_SECRET` | HMAC-derived short-lived capability | Convex only, at least 32 bytes; rotate to invalidate newly derived test capabilities. |
