...
| Hosted credential-free evidence | GitHub `Hosted Quality` for the exact revision | Clean-clone-safe repository/Studio contract, lint, documentation, asset, and dependency checks ran without secrets. | Full local verification, generated Convex types, a deployment, migration, or authenticated browser proof. |
